...
//    ArrayList<String> count = (ArrayList<String>) ServiceEvent.getInstance().stat().get("eventType");
//      System.out.println(count);
//      String[] ds =count .toArray(new String[count .size()]);
//      
//        String[] d = (String[]) ArrayUtils.toPrimitive(ds);
//    int k = 0;
//    for (double value : values) {
//        
//            
//            series.add(d[k], value);
//        k++;
//             
//    }
//
